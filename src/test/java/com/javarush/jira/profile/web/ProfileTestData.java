...
public interface ProfileTestData {
    MatcherFactory.Matcher<ProfileTo> PROFILE_TO_MATCHER = MatcherFactory.usingEqualsComparator(ProfileTo.class);
    long USER_ID = 1L;
    ...
    Set<ContactTo> ADMIN_CONTACTS = Set.of(CONTACT_GITHUB, CONTACT_TG, CONTACT_MOBILE);
